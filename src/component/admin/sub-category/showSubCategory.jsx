const ShowSubCategory = ({
  ...
  return (
    <>
      <div className=" flex  sm:ml-10 mx-4 sm:mr-4  lg:mx-8  overflow-x-auto md:overscroll-none  2xl:mb-16 xl:mb-12 lg:mb-10">
                ...
                allSubCategory?.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="flex gap-3 my-2 lg:w-2/12">
                      ...
                      <button
                        onClick={() => openDrawerOO({ subCateId: item?._id })}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
